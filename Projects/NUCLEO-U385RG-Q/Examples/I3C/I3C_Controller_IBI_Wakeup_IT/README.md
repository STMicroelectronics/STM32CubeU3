...
How to handle an I3C as Controller to perform an In-Band-Interrupt event between an I3C Controller in
Low Power Mode and I3C Targets.

      - Board: NUCLEO-U385RG-Q's (embeds a STM32U3xx device)
      - SDA Pin: PA6 (Arduino D12 CN5 pin 5, Morpho CN10 pin13)
      - SCL Pin: PA7 (Arduino D11 CN5 pin 4, Morpho CN10 pin15)
...
For this specific example, the In Band Interrupt have not payload. As on STM32U3xx product,
...
NUCLEO-U385RG-Q's LEDs can be used to monitor the transfer status:
 ...
 - LD2 is ON when Dynamic Address Assignment process is completed.
 - LD2 is OFF when the In Band Interrupt is completed.
 - LD2 is toggle slowly when there is an error in In Band Interrupt or Dynamic Address Assignment process.
...
### <b>Directory contents</b>
  ...
  - I3C/I3C_Controller_IBI_Wakeup_IT/Inc/stm32u3xx_nucleo_conf.h   BSP configuration file
  - I3C/I3C_Controller_IBI_Wakeup_IT/Inc/stm32u3xx_hal_conf.h      HAL configuration file
  - I3C/I3C_Controller_IBI_Wakeup_IT/Inc/stm32u3xx_it.h            I3C interrupt handlers header file
  - I3C/I3C_Controller_IBI_Wakeup_IT/Inc/main.h                    Header for main.c module
  - I3C/I3C_Controller_IBI_Wakeup_IT/Src/stm32u3xx_it.c            I3C interrupt handlers
  - I3C/I3C_Controller_IBI_Wakeup_IT/Src/main.c                    Main program
  - I3C/I3C_Controller_IBI_Wakeup_IT/Src/system_stm32u3xx.c        stm32u3xx system source file
  - I3C/I3C_Controller_IBI_Wakeup_IT/Src/stm32u3xx_hal_msp.c       HAL MSP file
...
### <b>Hardware and Software environment</b>
  ...
  - NUCLEO-U385RG-Q Set-up
    ...
    - Use short wire as possible between the boards or twist an independent ground wire on each I3C lines
      mean one GND twist around SCL and one GND twist around SDA to help communication at 12.5Mhz.
    - Connect I3C_SDA line of Controller board (PA6 Arduino D12 CN5 pin 5, Morpho CN10 pin13) to I3C_SDA line of Target Board (PA6 Arduino D12 CN5 pin 5, Morpho CN10 pin13).
    - Connect I3C_SCL line of Controller board (PA7 Arduino D11 CN5 pin 4, Morpho CN10 pin15) to I3C_SCL line of Target Board (PA7 Arduino D11 CN5 pin 4, Morpho CN10 pin15).
