...
One of the below scenario can occur :
 ...
 - LD2 toggles 2 times : wake-up from standby.
 - LD2 is ON after 15 seconds : Test is over, result is OK.
...
### <b>Directory contents</b>
  ...
  - RTC/RTC_LowPower_STANDBY_WUT/Inc/stm32u3xx_hal_conf.h     HAL configuration file
  - RTC/RTC_LowPower_STANDBY_WUT/Inc/stm32u3xx_it.h           Header for stm32u3xx_it.c
  - RTC/RTC_LowPower_STANDBY_WUT/Inc/main.h                   Header file for main.c
  - RTC/RTC_LowPower_STANDBY_WUT/Src/system_stm32u3xx.c       stm32u3xx system clock configuration file
  - RTC/RTC_LowPower_STANDBY_WUT/Src/stm32u3xx_it.c           Interrupt handlers
  - RTC/RTC_LowPower_STANDBY_WUT/Src/main.c                   Main program
  - RTC/RTC_LowPower_STANDBY_WUT/Src/stm32u3xx_hal_msp.c      HAL MSP module
