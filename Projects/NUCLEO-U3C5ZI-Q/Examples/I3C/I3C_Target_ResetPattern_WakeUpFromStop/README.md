...
The PWR Reset Pattern detection helps target to detect the Reset Pattern during the Stop3, Standby mode.
...
After wake up from Stop 3, the __HAL_PWR_GET_FLAG() function check Stop 3 flag.
...
NUCLEO-U3C5ZI-Q's LEDs can be used to monitor the transfer status:
 ...
 - LD1 is ON when target wakes up from Stop 3.
...
Current Consumption in Stop 3 Mode - 260 uA
