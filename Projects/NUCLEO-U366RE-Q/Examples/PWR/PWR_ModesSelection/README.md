...
#### <b>Current Consumption(SMPS Enabled(@3.3V))</b>
        ...
        Power mode : RUN - 96 MHz                                             2057 uA
        Power mode : RUN - 48 MHz                                             781.8 uA
        Power mode : SLEEP - 12 MHz                                           108.8 uA
        Power mode : STOP1 - Full SRAM (SRAM 1 + 2 = 256KB)                   59.3 uA
        Power mode : STOP1 - 8-KByte SRAM                                     56.46 uA
        Power mode : STOP2 - Full SRAM (SRAM 1 + 2 = 256KB)                   6.30 uA
        Power mode : STOP2 - 8-KByte SRAM                                     5.34 uA
        Power mode : STOP3 - Full SRAM (SRAM 1 + 2 = 256KB)                   1.498 uA
        Power mode : STOP3 - 8-KByte SRAM                                     1.34 uA
        Power mode : STANDBY - 8-KByte SRAM retention + RTC + ULPMEN=1        1.32 uA
        Power mode : STANDBY - No SRAM retention + RTC + ULPMEN=1             1.15 uA
        Power mode : STANDBY - No SRAM retention + No RTC + ULPMEN=1          0.64 uA
        Power mode : SHUTDOWN - w/ RTC                                        1.1 uA
        Power mode : SHUTDOWN - wo/ RTC                                       0.634 uA
...
### <b>Hardware and Software environment</b>
  ...
  - This example has been tested with STMicroelectronics NUCLEO-U366RET6-Q board
    embedding a low-speed clock LSE and can be easily tailored to any other
    supported device and development board.

  - NUCLEO-U366RET6-Q set-up:
