...
int main(void)
{
  ...
  __HAL_LINKDMA(&hi2c3, hdmatx, handle_GPDMA1_Channel6);
  MX_Queue_rx_Config();
  HAL_DMAEx_List_LinkQ(&handle_GPDMA1_Channel7, &Queue_rx);
  __HAL_LINKDMA(&hi2c3, hdmarx, handle_GPDMA1_Channel7);
...
static void MX_I2C3_Init(void)
{
  ...
  */
  ...
  sConfigI2C3.TriggerSelection = I2C_GRP2_GPDMA_CH3_TCF_TRG;
