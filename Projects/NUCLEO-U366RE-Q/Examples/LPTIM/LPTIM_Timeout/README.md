...
the MCU is woken-up by the compare match event and LD2 toggles.
...
Current consumption depends on the board population and the measurement setup.
Re-characterize these values on NUCLEO-U366RE-Q if low-power figures are required.
...
### <b>Directory contents</b>
  ...
  - LPTIM/LPTIM_Timeout/Inc/stm32u3xx_nucleo_conf.h    BSP configuration file
  - LPTIM/LPTIM_Timeout/Inc/stm32u3xx_hal_conf.h       HAL configuration file
  - LPTIM/LPTIM_Timeout/Inc/stm32u3xx_it.h             Interrupt handlers header file
  - LPTIM/LPTIM_Timeout/Inc/main.h                     Header for main.c module
  - LPTIM/LPTIM_Timeout/Src/stm32u3xx_it.c             Interrupt handlers
  - LPTIM/LPTIM_Timeout/Src/main.c                     Main program
  - LPTIM/LPTIM_Timeout/Src/stm32u3xx_hal_msp.c        HAL MSP module
  - LPTIM/LPTIM_Timeout/Src/system_stm32u3xx.c         STM32U3xx system source file
...
### <b>Hardware and Software environment</b>
  ...
  - This example has been tested with STMicroelectronics NUCLEO-U366RE-Q
