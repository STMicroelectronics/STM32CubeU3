...
This application provides an example of Azure RTOS USBX stack usage on NUCLEO-U366RE-Q board, it shows how to develop USB Device communication Class "CDC_ACM" based application.
...
When plugged to PC host, the NUCLEO-U366RE-Q must be properly enumerated as an USB Serial device and an STlink COM port.
...
Those descriptors are used by host driver to identify the device capabilities. Once NUCLEO-U366RE-Q USB device successfully completed the enumeration phase,
...
### <b>Hardware and Software environment</b>
  ...
  - This application runs on STM32U366xx devices
  - This application has been tested with STMicroelectronics NUCLEO-U366RE boards revision: MB1841-U366RG-E01
    and can be easily tailored to any other supported device and development board

  - NUCLEO-U366RE-Q Set-up:
    - Connect the NUCLEO-U366RE board CN3 to the PC through "TYPE-C" to "Standard A" cable.
