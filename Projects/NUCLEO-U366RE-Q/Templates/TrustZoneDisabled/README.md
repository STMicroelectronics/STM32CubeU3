...
- This project is targeted to run on STM32U366RE device on NUCLEO-U366RE-Q board from STMicroelectronics.  
...
### <b>Hardware and Software environment</b>
  ...
  - This template runs on STM32U366RE devices without security enabled (TZEN=0).
  - This template has been tested with STMicroelectronics NUCLEO-U366RE-Q (MB1841)
