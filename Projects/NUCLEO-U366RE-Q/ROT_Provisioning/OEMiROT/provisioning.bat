...
set   boot_cfg_h="%cube_fw_path%\Projects\NUCLEO-U366RE-Q\Applications\ROT\OEMiROT_Boot\Inc\boot_hal_cfg.h"
set flash_layout="%cube_fw_path%\Projects\NUCLEO-U366RE-Q\Applications\ROT\OEMiROT_Boot\Inc\flash_layout.h
...
echo        (NUCLEO-U366RE-Q: disconnect CN7/Pin5 from CN7/pin7)
echo        Press any key to continue...
echo.
if [%1] neq [AUTO] pause >nul
