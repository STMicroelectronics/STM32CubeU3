...
/**
  ******************************************************************************
  * @file    LCD/LCD_Blink_Frequency/Src/stm32u3xx_it.c
...
/* USER CODE BEGIN 1 */
/**
  * @brief  This function handles external ines 2 to 3 interrupt request.
  * @param  None
  * @retval None
  */
void EXTI3_IRQHandler(void)
{
  ...
  HAL_GPIO_EXTI_IRQHandler(JOY1_SEL_PIN);
