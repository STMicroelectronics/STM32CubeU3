...
After Reset the Blink frequency is equal to LCDCLK/16 and LCD Glass display "DK0016" string.
By pressing on the Joystick Sel push-button (PC.03) the Blink frequency is incremented
...
### <b>Keywords</b>
LCD, Joystick, Blink frequency, STM32U366

### <b>Directory contents</b>

  - LCD/LCD_Blink_Frequency/Inc/stm32u3xx_hal_conf.h    HAL configuration file
  - LCD/LCD_Blink_Frequency/Inc/stm32u3xx_it.h          Interrupt handlers header file
  - LCD/LCD_Blink_Frequency/Inc/main.h                  Header for main.c module
  - LCD/LCD_Blink_Frequency/Src/stm32u3xx_it.c          Interrupt handlers
  - LCD/LCD_Blink_Frequency/Src/main.c                  Main program
  - LCD/LCD_Blink_Frequency/Src/stm32u3xx_hal_msp.c     HAL MSP file
  - LCD/LCD_Blink_Frequency/Src/system_stm32u3xx.c      STM32U3xx system source file
