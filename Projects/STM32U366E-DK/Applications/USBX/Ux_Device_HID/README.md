...
This application provides an example of Azure RTOS USBX stack usage on STM32U366xx board,
...
When plugged to PC host, the STM32U366xx must be properly enumerated as an USB HID mouse device.
During the enumeration phase, device provides host with the requested descriptors (Device, configuration, string).
Those descriptors are used by host driver to identify the device capabilities.
Once the STM32U366xx USB device successfully completed the enumeration phase, the device sends a HID report after a user button press.
...
### <b>Hardware and Software environment</b>
  ...
  - This application has been tested with STMicroelectronics STM32U366E-DK boards revision MB2284-U366E_S-A02 and can be easily tailored to any other supported device and development board.
