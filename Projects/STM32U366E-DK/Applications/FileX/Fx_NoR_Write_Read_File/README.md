...
board. By default, it does not run on the STM32U366E-DK board, the user must add a custom board with NOR Flash support.
...
### <b>Hardware and Software environment</b>
  ...
  - This application has been tested using MIKROE Flash 6 Click board embedding a Winbond W25Q128JV NOR flash device and plugged on
    STM32U366E-DK board revision: MB2284-U366E_S-A02 and can be easily tailored to any other supported device and development board.
