...
First we initialize the hardware (leds)using BSP.

The TSC acquisition is then initiated by tsl_user_Exec().
When the end of acquisition occurs, the acquired data is manipulated using middleware STM32_TouchSensing_Library
and depending on the value under the max threshold values, the corresponding LEDs are set ON.
...
- LED1 toggles when ECS is ON (when no touch is detected (all sensors are in the RELEASE state)).
- LED3 is ON when a touch is detected.
- LED3 is OFF when the touch is released.
...
### <b>Directory contents</b>
  ...
  - Applications/TouchSensing/Inc/stm32u3xx_hal_conf.h          HAL configuration file
  - Applications/TouchSensing/Inc/stm32u3xx_it.h                Interrupt handlers header file
  - Applications/TouchSensing/Inc/main.h                        Header for main.c module
  - Applications/TouchSensing/Inc/STM32U366e_discovery_conf.h   STM32U366E-DK board configuration file
  - Applications/TouchSensing/Src/stm32u3xx_it.c                Interrupt handlers
  - Applications/TouchSensing/Src/main.c                        Main program
  - Applications/TouchSensing/Src/stm32u3xx_hal_msp.c           HAL MSP file
  - Applications/TouchSensing/Src/system_stm32u3xx.c            STM32U3xx system source file
