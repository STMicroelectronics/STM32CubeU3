...
This project is targeted to run on STM32U345xx device on NUCLEO-U345RC-Q board from STMicroelectronics.
...
### <b>Directory contents</b>
    ...
    - Templates_LL/TrustZoneDisabled/TrustZoneDisabled.ioc       STM32CubeMX project description file
...
### <b>Hardware and Software environment</b>
  ...
  - This template runs on STM32U345xx devices.

  - This template has been tested with STMicroelectronics NUCLEO-U345RC-Q
...
In order to make the program work, you must do the following :
 ...
 - Open TrustZoneDisabled.ioc with STM32CubeMX if you need to review the clock and middleware skeleton before porting an LL example
