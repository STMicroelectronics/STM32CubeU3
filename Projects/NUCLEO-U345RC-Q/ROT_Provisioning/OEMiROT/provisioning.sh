...
boot_cfg_h="$cube_fw_path/Projects/NUCLEO-U345RC-Q/Applications/ROT/OEMiROT_Boot/Inc/boot_hal_cfg.h"
flash_layout="$cube_fw_path/Projects/NUCLEO-U345RC-Q/Applications/ROT/OEMiROT_Boot/Inc/flash_layout.h"

# Initial configuration
connect_no_reset="-c port=SWD mode=HotPlug"
connect_reset="-c port=SWD mode=UR"
connect_hardware_reset="-c port=SWD mode=powerdown -hardRst"
...
echo "       (NUCLEO-U345RC-Q: disconnect CN7/Pin5 from CN7/pin7"
echo "       Press any key to continue..."
echo ""
if [ "$mode" != "AUTO" ]; then read -p "" -n1 -s; fi
