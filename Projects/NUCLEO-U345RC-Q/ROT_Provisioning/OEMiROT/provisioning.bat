...
set   boot_cfg_h="%cube_fw_path%\Projects\NUCLEO-U345RC-Q\Applications\ROT\OEMiROT_Boot\Inc\boot_hal_cfg.h"
set flash_layout="%cube_fw_path%\Projects\NUCLEO-U345RC-Q\Applications\ROT\OEMiROT_Boot\Inc\flash_layout.h
...
echo        Press any key to continue...
echo.
set "action=OBKey File Generation"
if [%1] neq [AUTO] pause >nul
