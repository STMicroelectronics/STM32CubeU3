...
int main(void)
{
  ...
  __HAL_LINKDMA(&hi2c1, hdmatx, handle_GPDMA1_Channel7);
  MX_Queue_rx_Config();
  HAL_DMAEx_List_LinkQ(&handle_GPDMA1_Channel6, &Queue_rx);
  __HAL_LINKDMA(&hi2c1, hdmarx, handle_GPDMA1_Channel6);
...
static void MX_I2C1_Init(void)
{
  ...
  */
  ...
  sConfigI2C1.TriggerSelection = I2C_GRP1_GPDMA_CH3_TCF_TRG;
