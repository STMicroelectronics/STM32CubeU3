...
### <b>Current Consumption</b>
        ...
        Power mode : RUN - 96 MHz                                             2085 uA
        Power mode : RUN - 48 MHz                                             773.8 uA
        Power mode : SLEEP - 12 MHz                                           105.8 uA
        Power mode : STOP1 - Full SRAM (SRAM 1 + 2 = 256KB)                   54.3 uA
        Power mode : STOP1 - 8-KByte SRAM                                     51.46 uA
        Power mode : STOP2 - Full SRAM (SRAM 1 + 2 = 256KB)                   5.90 uA
        Power mode : STOP2 - 8-KByte SRAM                                     5.44 uA
        Power mode : STOP3 - Full SRAM (SRAM 1 + 2 = 256KB)                   2.058 uA
        Power mode : STOP3 - 8-KByte SRAM                                     1.914 uA
        Power mode : STANDBY - 8-KByte SRAM retention + RTC + ULPMEN=1        1.041 uA
        Power mode : STANDBY - No SRAM retention + RTC + ULPMEN=1             0.88 uA
        Power mode : STANDBY - No SRAM retention + No RTC + ULPMEN=1          0.446 uA
        Power mode : SHUTDOWN - w/ RTC                                        0.823 uA
        Power mode : SHUTDOWN - wo/ RTC                                       0.38 uA    
...
### <b>Hardware and Software environment</b>
  ...
  - This example has been tested with STMicroelectronics NUCLEO-U345RC board
    embedding a low-speed clock LSE and can be easily tailored to any other
    supported device and development board.

  - NUCLEO-U345RC set-up:
