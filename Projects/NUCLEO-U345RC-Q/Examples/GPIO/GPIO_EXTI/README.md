...
In this example:
  ...
  - PC.13 is configured in interrupt mode with pull-down
  - when a rising edge is detected on External line 13 by pressing the User push-button, LD2 toggles once
