...
#define FLASH_AREA_1_SIZE              0xC800  /* Non-secure app image primary slot size */

#define FLASH_AREA_2_OFFSET            0x2A800  /* Secure app image secondary slot */

#define FLASH_AREA_2_SIZE              0x8000   /* Secure app image secondary slot size */

#define FLASH_AREA_3_OFFSET            0x32800  /* Non-secure app image secondary slot */

#define FLASH_AREA_3_SIZE              0xC800   /* Non-secure app image secondary slot size */
...
#define FLASH_PARTITION_SIZE           0x14000  /* Secure and Non Secure partition size */

#define FLASH_NS_PARTITION_SIZE        0xC800  /* Non Secure partition size */
