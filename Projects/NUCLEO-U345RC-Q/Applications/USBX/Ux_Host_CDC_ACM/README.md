...
The application creates 3 threads with different priorities :
  ...
  - cdc_acm_receive_app_thread_entry (Priority : 30; Preemption threshold : 30) used to receive data from the device.

#### <b> Expected success behavior</b>

- When a cdc device is plugged to  NUCLEO-U345RC board, a Message will be displayed on the uart HyperTerminal (STlink VCP) showing
...
### <b>Hardware and Software environment</b>
  ...
  - This application has been tested with STMicroelectronics NUCLEO-U345RC-Q boards
    and can be easily tailored to any other supported device and development board.

-  NUCLEO-U345RC-Q Set-up
    - Plug the USB CDC_ACM device into the  NUCLEO-U345RC board through 'Type C to A-Female' cable to the connector.
