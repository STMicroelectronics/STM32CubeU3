...
This application provides an example of Azure RTOS USBX stack usage on NUCLEO-U345RC-Q board, it shows how to develop USB Device communication Class "CDC_ACM" based application.
...
When plugged to PC host, the NUCLEO-U345RC-Q must be properly enumerated as an USB Serial device and an STlink COM port.
...
Those descriptors are used by host driver to identify the device capabilities. Once NUCLEO-U345RC-Q USB device successfully completed the enumeration phase,
...
### <b>Hardware and Software environment</b>
  ...
  - This application runs on STM32U345xx devices
  - This application has been tested with STMicroelectronics NUCLEO-U345RC-Q boards revision: MB1841-U345RC-Q
    and can be easily tailored to any other supported device and development board

  - NUCLEO-U345RC-Q Set-up:
    - Connect the NUCLEO-U345RC-Q board CN3 to the PC through "TYPE-C" to "Standard A" cable.
